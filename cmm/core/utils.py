#/---
"""
An assortment of functions which received multiple calls
"""
#/---
import numpy as np
...
#     """
#     v_ij = e_j-e_i
#     n_i = normal vector field evaluated at e_i
#     """
#     a,b = v_ij.copy(), n_i.copy()
#     c = dot(b.T,a.T)
#     #d = np.sqrt(1-dot(b.T,a.T)**2)
#     d = np.sqrt(dot(a.T,a.T) - 2*c**2 + dot(b.T,b.T)*c**2)
#
#     return np.array([(a[:,0]-c*b[:,0])/d, (a[:,1]-c*b[:,1])/d, (a[:,2]-c*b[:,2])/d])
#
#
# def normal_proj(n1, v):
#     n_temp = n1 - proj(n1,v).T
#     return div_norm(n_temp)
