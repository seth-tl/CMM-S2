#-----------------------------------------------------------------------------
"""
Experiments with numba to speed up code. 
Observes ~ 4x speed-up for linear advection solver
Eventually will be merged into existing code.
"""
# -----------------------------------------------------------------------------
import numpy as np
...
from ..core import spherical_simulations_jitted as sphere_sim
